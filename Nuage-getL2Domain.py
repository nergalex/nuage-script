...
--- Usage ---
Run 'python Nuage-getL2Domain.py -h' for an overview
...
def main():
    ...
    print ('   +--- gateway: %s' % (myDomain.gateway)) 
    print ('   +--- gateway_mac_address: %s' % (myDomain.gateway_mac_address))
    print ('   +--- address: %s' % (myDomain.address)) 
    print ('   +--- netmask: %s' % (myDomain.netmask))
    print ('   +--- description: %s' % (myDomain.description)) 
