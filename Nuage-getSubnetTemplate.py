...
"""
--- Object ---
Fetch a Subnet template

--- Usage ---
Run 'python Nuage-getSubnetTemplate.py -h' for an overview
...
def main():
    ...
    print ('|   |   |')
    print ('|   |   +--- Subnet Template %s :' % (mySubnetTemplate.name))
    print ('|   |        +--- id: %s' % (mySubnetTemplate.id))
