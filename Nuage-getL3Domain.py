...
--- Usage ---
Run 'python Nuage-getL3Domain.py -h' for an overview
...
python Nuage-getL3Domain.py   --log-file /root/Nuage_script/Nuage-log.txt --nuage-organization TEST --nuage-host 10.189.48.66 --nuage-port 8443 --nuage-password test2018 --nuage-user admin-test --nuage-myEnterprise TEST --nuage-myDomain Lille_vAES-1_DMZ-1_PXY-RBD_FRT
