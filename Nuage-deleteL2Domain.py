...
--- Usage ---
Run 'python Nuage-deleteL2Domain.py -h' for an overview
...
def main():
    ...
    print ('L2Domain %s id :%s' % (myDomain.name, myDomain.id))
    myDomain.delete()
    print ('L2Domain %s with id %s is deleted' % (nuage_myDomain, DomainId))
    logger.warning('L2Domain %s with id %s is deleted' % (nuage_myDomain, DomainId))
