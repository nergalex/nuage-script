...
"""
--- Object ---
Fetch a Zone template

--- Usage ---
Run 'python Nuage-getZoneTemplate.py -h' for an overview
...
python Nuage-getZoneTemplate.py   --log-file Nuage-log.txt --nuage-organization TEST --nuage-host 127.1.1.2 --nuage-port 8443 --nuage-password test2018 --nuage-user admin-test --nuage-myEnterprise TEST --nuage-myDomain L3_PXY-RBD_BCK --nuage-myZone Interco
...
def main():
    ...
    print ('|   |')
    print ('|   +--- Zone Template %s :' % (myZoneTemplate.name))
    print ('|        +--- id: %s' % (myZoneTemplate.id))
