...
def main():
    ...
    if not mySecurityPolicy:
        print('ERROR: Security Policy %s not found.', nuage_mySecurityPolicyName)
        exit(1)

    mySecurityPolicyId = mySecurityPolicy.id

    mySecurityPolicy.delete()
    print ('Security Policy %s with id %s is deleted' % (nuage_mySecurityPolicyName, mySecurityPolicyId))
    logger.warning('Security Policy %s with id %s is deleted' % (nuage_mySecurityPolicyName, mySecurityPolicyId))
