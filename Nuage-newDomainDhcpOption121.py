...
"""
--- Object ---
Set DHCP option 121 for a domain 

--- Usage ---
Run 'python Nuage-setDomainDhcpOption121.py -h' for an overview
...
def get_args():
    ...
    parser.add_argument('--nuage-myDhcpValue', required=True, help='DHCP value (Hex)', dest='nuage_myDhcpValue', type=str)
    parser.add_argument('--nuage-myDhcpLength', required=False, help='DHCP length (Hex)', dest='nuage_myDhcpLength', type=str)
...
def main():
    ...
    nuage_myDhcpLength  = args.nuage_myDhcpLength
    ...
    myNewDhcpOption = vsdk.NUDHCPOption(
                                        type = '79',
                                        value = nuage_myDhcpValue,
                                        length = nuage_myDhcpLength,
