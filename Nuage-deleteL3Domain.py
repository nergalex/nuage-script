...
--- Usage ---
Run 'python Nuage-deleteL3Domain.py -h' for an overview
...
python Nuage-deleteL3Domain.py   --log-file Nuage-log.txt --nuage-organization TEST --nuage-host 127.1.1.2 --nuage-port 8443 --nuage-password test2018 --nuage-user admin-test --nuage-myEnterprise TEST --nuage-myDomain L3_PXY-RBD_BCK
...
def main():
    ...
    print ('L3Domain %s id :%s' % (myDomain.name, myDomain.id))
    myDomain.delete()
    print ('L3Domain %s with id %s is deleted' % (nuage_myDomain, DomainId))
    logger.warning('L3Domain %s with id %s is deleted' % (nuage_myDomain, DomainId))
