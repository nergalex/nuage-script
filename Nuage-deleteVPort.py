...
"""
--- Object ---
Delete a vPort for a baremetal or a physical appliance

--- Usage ---
Run 'python Nuage-deleteVPortBaremetal.py -h' for an overview
...
def main():
    ...
    myVPort.delete()
    print ('Entreprise %s > Domain %s > Zone %s > Subnet %s > vPort %s is deleted : %s' % (myEnterprise.name, myDomain.name, myZone.name, mySubnet.name, vPortName, vPortId ))
    logger.warning ('Entreprise %s > Domain %s > Zone %s > Subnet %s > vPort %s is deleted : %s' % (myEnterprise.name, myDomain.name, myZone.name, mySubnet.name, vPortName, vPortId ))
