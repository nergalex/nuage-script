...
"""
--- Object ---
Delete a L3 Domain template

--- Usage ---
Run 'python Nuage-deleteL3DomainTemplate.py -h' for an overview
...
python Nuage-deleteL3DomainTemplate.py   --log-file Nuage-log.txt --nuage-organization TEST --nuage-host 127.1.1.2 --nuage-port 8443 --nuage-password test2018 --nuage-user admin-test --nuage-myEnterprise TEST --nuage-myDomain L3_PXY-RBD_BCK
