...
--- Usage ---
Run 'python Nuage-deleteSubnet.py -h' for an overview
...
def main():
    ...
    print ('Subnet %s id :%s' % (mySubnet.name, mySubnet.id))
    
    mySubnet.delete()
    print ('Subnet %s with id %s is deleted' % (nuage_mySubnetName, SubnetId))
    logger.warning('Subnet %s with id %s is deleted' % (nuage_mySubnetName, SubnetId))
