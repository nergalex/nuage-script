...
"""
--- Object ---
Delete Static Routes of a Domain

--- Usage ---
Run 'python Nuage-deleteStaticRoutes.py -h' for an overview
...
def main():
    ...
    for cur_route in myDomain.static_routes.get():
        tmpAddress = cur_route.address
        tmpNetmask = cur_route.netmask
        tmpNH = cur_route.next_hop_ip
        cur_route.delete()
        print ('|   +-- Route %s %s via %s is deleted' % (tmpAddress, tmpNetmask, tmpNH))
